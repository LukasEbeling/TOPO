...
void topo_HHbbWW_1mu_v4(
    ...
    #pragma HLS INTERFACE ap_vld port=dropout_input,layer8_out 
    #pragma HLS PIPELINE
    ...
    nnet::dense<layer7_t, result_t, config8>(layer7_out, layer8_out, w8, b8); // munet_output
